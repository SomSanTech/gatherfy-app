  ...
  return (
    <>
      ...
      <View className="flex-1 relative">
        <View className="absolute inset-0 w-full top-[40%]">
          <View className="w-full">
            <Text className="text-5xl text-primary text-center w-full font-League-Gothic">
              Gatherfy
            </Text>
            <Text className="text-lg mt-2 text-primary text-center w-full font-Poppins-ExtraLight">
            Effortless Event Coordination
            </Text>
          </View>
        </View>
